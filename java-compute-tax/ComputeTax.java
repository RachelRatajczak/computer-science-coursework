...
public class ComputeTax {
	...
	public static void main(String[] args) {
		...
		// Ask the user their filing status
		Scanner input = new Scanner(System.in);
		
		System.out.println("(0 - single filers, 1 - married filing jointly "
				+ "or qualified widow(er), 2 - married filing separately, " +
		...
		// Tax variable to use in switch statement 
		double tax = 0;
		
		// Switch statement: tax computation based on filing status
		switch (status) {
		case 0: // single filers
			if (income <= 8350)
				tax = income * 0.10;
			...
			break;
		case 1: // married jointly or qualified widow(er)
			if (income <= 16700)
				tax = income * 0.10;
